    ...
    <section id="doctor" className="relative py-20 sm:py-32 scroll-mt-24">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-12 lg:gap-16 items-center">
          {/* Photo side */}
          <Reveal variant="left" className="relative mx-auto w-full max-w-[440px]">
            ...
            <div className="relative rounded-[34px] p-2 bg-gradient-to-br from-saffron-400/70 via-cream-100 to-forest-200/60 shadow-luxe-lg">
              <div className="relative rounded-[27px] overflow-hidden group">
                ...
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-forest-950 via-forest-950/55 to-transparent pt-20 pb-6 px-6">
                  <div className="flex items-center gap-3.5">
                    <img src={IMAGES.doctorPortrait} alt={SITE.doctorName} className="w-12 h-12 rounded-full object-cover ring-2 ring-saffron-400/80" />
                    <div>
            ...
            <div className="absolute -right-3 sm:-right-6 -top-5 glass rounded-2xl px-4 py-3 shadow-lg animate-float flex items-center gap-2.5">
              <span className="grid place-items-center w-9 h-9 rounded-xl bg-forest-900 text-saffron-300">
                <Languages className="w-4.5 h-4.5" />
              </span>
              <span className="text-xs font-semibold text-forest-900 leading-tight">{SITE.languages}</span>
            </div>

            <div className="absolute -left-3 sm:-left-6 bottom-24 glass rounded-2xl px-4 py-3 shadow-lg animate-float-slow flex items-center gap-2.5">
              <span className="grid place-items-center w-9 h-9 rounded-xl bg-saffron-500 text-white">
                <MapPin className="w-4.5 h-4.5" />
              </span>
              <span className="text-xs font-semibold text-forest-900 leading-tight">In-Clinic +<br />Online Worldwide</span>
            </div>
          </Reveal>
