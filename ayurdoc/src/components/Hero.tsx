      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.9fr)] gap-8 lg:gap-8 xl:gap-10 items-center">
          <div className="hero-copy max-w-xl lg:max-w-none">
            <div
              className={`inline-flex flex-wrap items-center gap-2 rounded-full glass gold-hairline pl-1.5 pr-4 py-1.5 transition-all duration-1000 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}
            >
              <span className="inline-flex items-center gap-1.5 rounded-full bg-forest-950 text-cream-100 text-[10px] sm:text-[11px] font-semibold px-3 py-1.5 tracking-wide">
                <BadgeCheck className="w-3.5 h-3.5 shrink-0 text-saffron-400" /> {t.hero.badge}
              </span>
              <span className="text-[11.5px] sm:text-[12.5px] font-medium text-forest-800 tracking-wide pr-1">
                {t.hero.badgeSub}
              </span>
            </div>
