              ...
              {status === "success" ? (
                <div className="px-6 sm:px-8 py-10 text-center" role="status" aria-live="polite">
                  ...
                  <div className="mt-6 rounded-2xl bg-emerald-50 border border-emerald-200 p-4 text-left max-w-md mx-auto space-y-2">
                    <p className="flex items-start gap-2 text-[13.5px] text-emerald-900"><CheckCircle2 className="w-[18px] h-[18px] shrink-0 mt-0.5" /> Keep your child&apos;s recent reports & growth records ready</p>
                    <p className="flex items-start gap-2 text-[13.5px] text-emerald-900"><CheckCircle2 className="w-[18px] h-[18px] shrink-0 mt-0.5" /> Note 2–3 photos if skin/allergy concern (helps a lot)</p>
                    <p className="flex items-start gap-2 text-[13.5px] text-emerald-900"><CheckCircle2 className="w-[18px] h-[18px] shrink-0 mt-0.5" /> Urgent? WhatsApp us directly — mention Ref #{refId}</p>
                  </div>
                  <button
